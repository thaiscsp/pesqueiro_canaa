	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-12">
			...
			<form method="post" action="" enctype="multipart/form-data">
				...
				<br><br>
				<center><input name="operacao" type="submit" value="Adicionar"></center>
			</form>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-12">
			<br><br><h2 class="text-center">Remover</h2>
			<center><hr></center>
			<form method="post" action="" enctype="multipart/form-data">
				@csrf
				<label for="nome">Nome: </label>
				<input type="text" name="nome" required>
				<br><br>
				<center><input name="operacao" type="submit" value="Remover"></center>
			</form>
		</div>
	</div>
	<br>
